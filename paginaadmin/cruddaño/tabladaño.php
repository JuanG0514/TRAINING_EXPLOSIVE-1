...
<body>
    ...
    <div class="nav-responsive" id="icono-nav">
      ...
      <br>
    <div>
        <h2>¡ACTUALIZA EL MÉTODO DE DAÑO MUSCULAR! </h2>
        <table>
            <thead>
                <tr>
                    <th>Repeticiones</th>
            ...
            <tbody>
                <?php while ($row = mysqli_fetch_array($query)): ?>
                    <tr>
                        ...
                        <th><a href="deletedaño.php?id_daño=<?= $row['id_daño'] ?>"><i class="fa-solid fa-trash-can"></i></a></th>
                    </tr>
                <?php endwhile; ?>
            </tbody>
        </table>
