...
.nav-responsive {
  ...
  .inicio {
  height: 100vh;
  background: linear-gradient(rgba(0,1,3,.5), rgba(0,0,0,.7)), url(../imagenes/ftportada.jpg);
  background-size: cover;
...
<body>
   ...
   <section id="Inicio" class="inicio">
    <div class="contenido-seccion">
      <div class="info">
          <br><br><h2>¿QUÉ DESEAS HACER?</h2>
          <button class="boton-actualizar" onclick="location.href='crudregistro/tabla.php'">VER CLIENTES</button><br><br>
          <button class="boton-actualizar" onclick="location.href='crudfuerza/registrorutinafuerza.php'">ACTUALIZAR FUERZA</button><br><br>
          <button class="boton-actualizar" onclick="location.href='crudestres/registrorutinaestres.php'">ACTUALIZAR ESTRÉS METABÓLICO</button><br><br>
          <button class="boton-actualizar" onclick="location.href='cruddaño/registrorutinadaño.php'">ACTUALIZAR DAÑO MUSCULAR</button>
    </div>
  </div>
  </section>
</body>
