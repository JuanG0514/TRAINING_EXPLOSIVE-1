...
<head>
    ...
    <title>ESTRÉS_METABÓLICOS</title>
<style>
    /*CSS tabla */
body{
...
<body>
    ...
    <div class="nav-responsive" id="icono-nav">
      ...
      <br>
    <div>
        <h2>¡ACTUALIZA EL MÉTODO DE ESTRÉS METABÓLICO! </h2>
        <table>
            <thead>
                <tr>
                    <th>Repeticiones</th>
            ...
            <tbody>
                <?php while ($row = mysqli_fetch_array($query)): ?>
                    <tr>
                        ...
                        <th><a href="deleteestres.php?id_estres=<?= $row['id_estres'] ?>"><i class="fa-solid fa-trash-can"></i></a></th>
                    </tr>
                <?php endwhile; ?>
            </tbody>
        </table>
