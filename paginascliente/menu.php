...
.nav-responsive {
  ...
  .inicio {
  height: 100vh;
  background: linear-gradient(rgba(0,1,3,.5), rgba(0,0,0,.7)), url(../imagenes/fondomancu.jpeg);
  background-size: cover;
...
.perfil-container:hover .menu-desplegable {
    display: block; 
}
</style>
<!--BARRA HTML-->
<body>
    <div class="contenedor-header">
      ...
      <div class="nav-responsive" id="icono-nav">
        ...
        <a href="infousuario/tabla.php?id=<?php echo $id; ?>">Mis datos</a>
   ...
   <section id="Inicio" class="inicio">
    <div class="contenido-seccion">
      <div class="info">
          <br><br><br><br><h2>MENÚ</h2><br>
          <h1>¿QUÉ TRABAJARÁS HOY?</h1>
          <button class="boton-tren-superior" onclick="location.href='trensuperior.html'">TREN SUPERIOR</button>  <br><br>
          <button class="boton-tren-superior" onclick="location.href='treninferior.html'">TREN INFERIOR</button>  <br><br>
    </div>
  </div>
  </section>
</body>
